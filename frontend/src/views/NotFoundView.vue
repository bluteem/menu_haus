<template>
	<div class="min-h-screen flex items-center justify-center w-10/12 m-auto">
		...
		<div class="w-full md:w-1/2 p-4 md:p-8">
			<img :src="logo" class="w-28 h-28 mb-8 mr-6 inline-block" alt="" />
			<h1 class="text-6xl font-bold text-gray-800 inline-block mb-8">:</h1>
			<p class="text-xl md:text-2xl text-gray-600 mb-8">Oops! The page you are looking for could not be found.</p>
			<a
				href="/"
				class="px-6 py-3 bg-blue-500 text-white text-lg rounded-lg inline-block hover:bg-blue-600 transition duration-300 ease-in-out"
				>Go Back Home</a
			>
		</div>
	</div>
