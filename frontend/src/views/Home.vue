    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-center">
            <div class="w-full">
                <!-- Tabs -->
                <div class="sm:hidden">
                    <select aria-label="Selected tab" v-model="selectedTab"
                        class="block w-full p-2 border-gray-300 rounded-md">
                ...
                <div class="hidden sm:block">
                    <nav class="flex space-x-4" aria-label="Tabs">
                        <button v-for="(tab, index) in tabs" :key="index"
                            :class="{ 'bg-gray-900 text-white': selectedTab === tab.value, 'text-gray-300 hover:bg-gray-700 hover:text-white': selectedTab !== tab.value }"
        ...
        <div class="mt-4">
            <div v-for="(tab, index) in tabs" :key="index" v-if="selectedTab === tab.value">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div v-for="(menuItem, idx) in menuItems" :key="idx" v-if="menuItem.category === tab.value"
...
export default {
    data() {
        return {
            ...
            tabs: [ // Array of tabs
                { label: 'All', value: 'All' }, // Initial tab to show all items
                { label: 'Appetizers', value: 'Appetizers' }, // Sample tab
                { label: 'Main Course', value: 'Main Course' }, // Sample tab
                { label: 'Desserts', value: 'Desserts' } // Sample tab
            ],
