<template>
	<div
		...
		<div class="max-w-sm w-full bg-orange-50 shadow-lg rounded-lg pointer-events-auto">
					...
					<div class="flex items-start">
						<div class="flex-shrink-0">
							...
							<svg
								...
								viewBox="0 0 24 24"
								xmlns="http://www.w3.org/2000/svg">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M21 3L3 21"></path>
							</svg>
						</div>
...
export default {
	...
	props: {
		alertType: {
			type: String,
			default: "error", // Default to success type
		},
	},
	data() {
		return {
